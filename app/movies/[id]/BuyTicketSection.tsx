                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="text-right">
                        <div className="text-lg md:text-xl font-bold text-[#e50914]">
                          {session.basePrice}с
                        </div>
                        {session.vipPrice && (
                          <div className="text-xs md:text-sm text-yellow-400 font-semibold">
          ...
          {selectedSession && (
            <div className="flex justify-center pt-6">
              <button
                ...
                className="w-full md:w-auto px-8 md:px-12 py-3 md:py-4 bg-[#e50914] text-white rounded-lg md:rounded-lg font-bold text-base md:text-lg hover:bg-[#c50812] transition-colors"
              >
