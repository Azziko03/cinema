...
- **Бургер-меню** - навигационные кнопки (Главная, Фильмы, Новинки, Мой список) скрыты в боковом меню на мобильных устройствах
- **Карусель сеансов** - отображение постеров текущих сеансов с названиями фильмов в полноэкранном режиме
